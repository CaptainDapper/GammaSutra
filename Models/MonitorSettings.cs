...
public class MonitorSettings
{
    ...
    public int CurveMode { get; set; } = 0; // 0 = Normal, 1 = Node
    ...
    public List<NodePoint>?[] NodePoints { get; set; } = [null, null, null];
    ...
    public MonitorSettings Clone() => new()
    {
        ...
        NodePoints          = [NodePoints[0]?.Select(p => p.Clone()).ToList(),
                               NodePoints[1]?.Select(p => p.Clone()).ToList(),
                               NodePoints[2]?.Select(p => p.Clone()).ToList()],
